...
import { PlaceOrderInpoutDto } from "./place-order.dto";
...
describe("PlaceOrderUseCase unit test", () => {
    describe("ValidateProducts methods", () => {
        ...
        it("should throw error if no products are selected", async () => {
            const input: PlaceOrderInpoutDto = {
                clientId: "123",
                products: [],
            };
    ...
    describe("execute method", () => {
        ...
        it("should throw an error when client not found", async () => {
            ...
            const input: PlaceOrderInpoutDto = { clientId: "0", products: [] };
        ...
        it("should throw an error when products ares not valid", async () => {
            const mockClientFacade = {
            ...
            const input: PlaceOrderInpoutDto = { clientId: "1", products: [] };
            await expect(placeOrderUseCase.execute(input)).rejects.toThrow(
